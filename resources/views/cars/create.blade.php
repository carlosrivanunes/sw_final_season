    ...
    <div class="card shadow-sm border-0" style="border-radius: 15px; background-color: rgba(255, 255, 255, 0.95);">
        <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <h2 class="mb-0" style="color: #1e3a8a; font-weight: 600;">Adicionar Carro</h2>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group" style="border-radius: 10px; overflow: hidden;">
                            ...
                            <input type="text" class="form-control @error('brand') is-invalid @enderror" id="brand" name="brand" value="{{ old('brand') }}" placeholder="Ex: Toyota" style="border-left: none; border-radius: 0 10px 10px 0;">
                        </div>
                        @error('brand')
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group" style="border-radius: 10px; overflow: hidden;">
                            ...
                            <input type="text" class="form-control @error('model') is-invalid @enderror" id="model" name="model" value="{{ old('model') }}" placeholder="Ex: Corolla" style="border-left: none; border-radius: 0 10px 10px 0;">
                        </div>
                        @error('model')
                            <div class="invalid-feedback d-block">
                                <i class="bi bi-exclamation-circle-fill me-1"></i>{{ $message }}
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group" style="border-radius: 10px; overflow: hidden;">
                            ...
                            <input type="number" class="form-control @error('year') is-invalid @enderror" id="year" name="year" value="{{ old('year') }}" placeholder="Ex: 2023" min="1900" max="2100" style="border-left: none; border-radius: 0 10px 10px 0;">
                        </div>
                        @error('year')
                            <div class="invalid-feedback d-block">
                                <i class="bi bi-exclamation-circle-fill me-1"></i>{{ $message }}
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group" style="border-radius: 10px; overflow: hidden;">
                            ...
                            <input type="text" class="form-control @error('color') is-invalid @enderror" id="color" name="color" value="{{ old('color') }}" placeholder="Ex: Azul" style="border-left: none; border-radius: 0 10px 10px 0;">
                        </div>
                        @error('color')
                            <div class="invalid-feedback d-block">
                                <i class="bi bi-exclamation-circle-fill me-1"></i>{{ $message }}
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group" style="border-radius: 10px; overflow: hidden;">
                            ...
                            <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price') }}" placeholder="Ex: 50000.00" min="0" style="border-left: none; border-radius: 0 10px 10px 0;">
                        </div>
                        @error('price')
                            <div class="invalid-feedback d-block">
                                <i class="bi bi-exclamation-circle-fill me-1"></i>{{ $message }}
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group" style="border-radius: 10px; overflow: hidden;">
                            ...
                            <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ old('quantity') }}" placeholder="Ex: 10" min="0" style="border-left: none; border-radius: 0 10px 10px 0;">
                        </div>
                        @error('quantity')
                            <div class="invalid-feedback d-block">
                                <i class="bi bi-exclamation-circle-fill me-1"></i>{{ $message }}
                    ...
                    <div class="col-12 mb-4">
                        ...
                        @enderror
                        <small class="text-muted">Escolha uma imagem para o carro (JPG, PNG, etc.).</small>
                    </div>
                </div>
